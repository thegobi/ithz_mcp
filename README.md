...
3. The agent downloads or clones this package repository, expands `ithz_mcp-v0.1-product-candidate.zip`, runs smoke checks, initializes the current project, reuses existing `project.ithz` if present, and configures local MCP/Git-driver support.
