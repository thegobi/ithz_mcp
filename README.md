...
3. The agent clones this package repository, expands `ithz_mcp.zip`, runs smoke checks, initializes the current project, reuses an existing `project.ithz` if present, and configures local MCP/Git-driver support.
